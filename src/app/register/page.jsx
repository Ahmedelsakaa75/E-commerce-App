...
const Register = () => {
  ...
  return (
    <div className="container mx-auto py-10 max-w-6xl">
      <Header title="Register | My Next.js App" />
          ...
          <Form className="max-w-md mx-auto space-y-4">
            ...
            <div>
              ...
              <Field
                ...
                className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-lg"
              />
              <ErrorMessage name="street" component="p" className="text-red-600" />
            </div>
            ...
            <div>
              ...
              <Field
                ...
                className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-lg"
              />
              <ErrorMessage name="zipcode" component="p" className="text-red-600" />
            </div>
            ...
            <button type="submit" disabled={isSubmitting} className="w-full bg-green-600 text-white py-2 rounded-lg hover:bg-green-700">
